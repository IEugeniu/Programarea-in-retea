...
namespace HttpClientApp
{
     class Program
     {
          static void Main(string[] args)
          {
               ...
               Console.WriteLine("3. Add a course (myAPI)");
               ...
               while (k != 6)
               {
                    switch (k)
                    {
                         ...
                         case 3:
                              ...
                              Console.WriteLine("6. Artificial Intelligence");
                              ...
                              Console.WriteLine("Enter description of the course:");
                              string description = Console.ReadLine();

                              string json = "{\"name\": \"" + name + "\", \"courseCategoryId\": " + categoryId + ", \"description\": \"" + description + "\", \"authorId\": 2}";
          ...
          static void GetAnnouncement(string searchQuery)
          {
               ...
               string path = @"C:\Users\User\Desktop\HttpClientApp\WebSiteData.txt";
          ...
          static void PostCourse(string json)
          {
               HttpWebRequest request = (HttpWebRequest)WebRequest.Create("https://localhost:44305/api/courses");
               ...
               using (var reader = new StreamReader(response.GetResponseStream(), encoding))
               {
                    using (JsonReader sdr = new JsonTextReader(reader))
                    {
                         ...
                         responseObj = serializer.Deserialize(sdr);
                    }
